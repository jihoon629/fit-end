...
public class RawFood {
    ...
    public RawFood(Long id, String foodCd, String foodNm, String dataCd, String typeNm, String foodOriginCd,
            ...
            Double nutConSrtrQua, Double enerc, Double water, Double prot, Double fatce, Double ash, Double chocdf,
            Double sugar, Double fibtg, Double ca, Double fe, Double p, Double k, Double nat, Double vitaRae,
            Double retol, Double cartb, Double thia, Double ribf, Double nia, Double vitc, Double vitd, Double chole,
            Double fasat, Double fatrn, String srcCd, String srcNm, Double servSize, Double foodSize,
            String itemMnftrRptNo, String mfrNm, String imptNm, String distNm, Boolean imptYn, String cooCd,
            String cooNm, String dataProdCd, String dataProdNm, String crtYmd, String crtrYmd, String insttCode,
            String insttNm) {
        this.id = id;
        this.foodCd = foodCd;
        this.foodNm = foodNm;
